<template>
  <Grid justify-content="center" align-items="center" class="stats-component">
    <DevQuoteCard />
    <GlassMorphismCard class="stack-overflow">Stackoverlow</GlassMorphismCard>
    <GlassMorphismCard :right="20" :top="30" class="github">
      Github
    </GlassMorphismCard>
    <GlassMorphismCard :top="30" class="dev-to">Dev.to</GlassMorphismCard>
    <GlassMorphismCard :bottom="50" class="youtube">Youtube</GlassMorphismCard>
    <GlassMorphismCard :right="30" class="google">Google</GlassMorphismCard>
  </Grid>
</template>

<script>
import DevQuoteCard from "./DevQuoteCard";
import GlassMorphismCard from "./glass-morphism/Wrapper";
